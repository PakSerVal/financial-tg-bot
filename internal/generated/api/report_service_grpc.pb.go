...
type ReportClient interface {
	SendReport(ctx context.Context, in *SendReportIn, opts ...grpc.CallOption) (*SendReportOut, error)
}
...
func (c *reportClient) SendReport(ctx context.Context, in *SendReportIn, opts ...grpc.CallOption) (*SendReportOut, error) {
	out := new(SendReportOut)
	err := c.cc.Invoke(ctx, "/gateway.v1.Report/SendReport", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ReportServer interface {
	SendReport(context.Context, *SendReportIn) (*SendReportOut, error)
...
func (UnimplementedReportServer) SendReport(context.Context, *SendReportIn) (*SendReportOut, error) {
...
func _Report_SendReport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gateway.v1.Report/SendReport",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReportServer).SendReport(ctx, req.(*SendReportIn))
	}
